 ...
 * bitta JS faylni ishga tushiradi. Shu sababli Next.js'ni o'z serverimiz
 * ichida ko'taramiz.
 *
 * Portni Passenger o'zi beradi (`PORT`); mahalliy sinovda 3000 ishlatiladi.
 *
 * MUHIM: bu faylni ishlatishdan oldin `npm run build` bajarilgan bo'lishi
 * kerak — bu yerda faqat tayyor build ishga tushiriladi.
 */
